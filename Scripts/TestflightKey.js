...
$notify("TestFlight automatically joins", "information acquisition success", "");

} else {

$notify ("TestFlight joins automatically", "Information fetch failed", "Please add testflight.apple.com");
  }
  $done({});
...
$notify("TestFlight automatically joined", `Added APP_ID: ${id}`, `Current ID: ${appId}`);
